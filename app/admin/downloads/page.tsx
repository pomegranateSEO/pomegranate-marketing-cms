...
<div className="text-center py-12 border-2 border-dashed rounded-lg bg-muted">
           ...
           <p className="text-muted-foreground mb-6">Create your first downloadable resource.</p>
           <Button onClick={() => setIsCreating(true)}>
             Create Download
           </Button>
        </div>
...
<tr key={download.id} className="hover:bg-muted/50">
                   <td className="px-6 py-4">
                     <div className="font-medium text-foreground">{download.title}</div>
                     {download.description && (
                       <div className="text-xs text-muted-foreground truncate max-w-xs">{download.description}</div>
                     )}
                   </td>
                   <td className="px-6 py-4">
...
<td className="px-6 py-4 text-muted-foreground">{download.sort_order}</td>
